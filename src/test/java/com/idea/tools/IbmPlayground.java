...
public class IbmPlayground {
    ...
    private static final String QMGR = "MQA01"; // Queue manager name
...
//    private static final String APP_PASSWORD = "_APP_PASSWORD_"; // Password that the application uses to connect to MQ
    private static final String APP_PASSWORD = "admin"; // Password that the application uses to connect to MQ
